...
protected:
	...
	public:
		...
		ExcelHAlign halign;
		ExcelVAlign valign;
		void setSpan(String text,int hspan=1,int vspan=1,ExcelHAlign halign=ExcelHAlign::Center,ExcelVAlign valign=ExcelVAlign::Middle,unsigned fillColor=16777215,unsigned borderColor=14277081);
	private:
